...
const SERVICES = [
  ...
  {
    id: '05',
    shortTitle: 'Мульчирование',
    title: 'Декоративная щепа',
    description: 'Професcиональное покрытие почвы органической мульчей. Улучшает структуру, сохраняет влагу и надолго защищает от сорняков.',
    price: 'от 3 000 ₽',
